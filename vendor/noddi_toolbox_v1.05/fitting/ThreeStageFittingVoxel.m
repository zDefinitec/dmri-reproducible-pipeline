...
% function [gsps, fobj_gs, mlps, fobj_ml, error_code, ps] = ThreeStageFittingVoxel(Epn, protocol, model, verbose)
%
% This function performs the three stage fitting routine used in
...
% Input:
%
% Epn       - the measured signals
%
% protocol  - the measurement protocol
%
% model     - the model structure created with MakeModel
%
% verbose   - an optional argument: 1 for printing verbose messages during
%             fitting, 0 for quiet (default)
%
%
...
try
    ...
    % if the function fails, record the event in the error_code and skip
