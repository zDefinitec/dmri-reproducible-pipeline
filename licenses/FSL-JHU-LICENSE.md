...
Most of FSL is covered by a _free for non-commercial purposes_ license. Use for which any financial return is received shall be defined as commercial use. If you are interested in using the Software commercially, please contact Oxford University Innovation ("OUI") by sending an email to <fsl@innovation.ox.ac.uk>.

Some components of FSL are released under an open source license - the relevant license can be found alongside the source code for those components.

Installing a full version of FSL will also cause third party libraries to be installed; these are released under a range of different open source licenses.


The full text of the FSL license is as follows:
...
The Cerebellum and Harvard-Oxford atlases, whilst not being the property
of Oxford, are released under the CC BY-SA 4.0 licence ( please see
https://creativecommons.org/licenses/by-sa/4.0/ regarding details ). For
any licencing issues, please contact the relevant primary co-ordinator:

Cerebellum: j.diedrichsen@bangor.ac.uk
Harvard-Oxford: steve@fmrib.ox.ac.uk

The JHU, Juelich, Striatum and Thalamus atlases, whilst not being the
property of Oxford, are released under the terms of the main FSL licence
above, at the request of their owners. These atlases should therefore
not be used for commercial purposes; for such purposes please contact
the primary co-ordinator for the relevant atlas:
